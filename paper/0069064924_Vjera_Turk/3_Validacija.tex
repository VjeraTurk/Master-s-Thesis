...
Postoji i još jedan èesto korišten grafièki oblik matrice. Vrijednosti u matrici mogu se normalizirati na opseg vrijednosti koji je moguæe prikazati u obliku slike tako da svaka vrijednost predstavlja vrijednost piksela. Koriste se razlièite palete, od raspona 0-100  koji predlažu \cite{Filic:2016.}, prikazom nijansama jedne boje 0-255 engl. \textit{grayscale} \ref{fig:diagonal}, paletom nijansa 2 boje (dodati sliku*), ili kojom drugom proizvoljnom paletom više boja \ref{fig:journeys}.

(...)\\
-"heatmap"\\
-problematika "normalizacija" na vrijednosti 0-255?\\
