...
\begin{figure}[!htbp]
	\begin{center}
		\includegraphics[width=13cm,keepaspectratio=true]{Voronoi-Shenzhen}
...
\subsubsection{Pravokutna mreža i mreža Heksagona}
Uniformna podjela na pravokutne blokove od 1km spominje se kao dobra praksa
\cite{Goulding:2016.} (...)

Podruèje pokrivanja bazne stanice na grafikama se standardno prikazuje kao heksagon. \cite{Teralytics:2017.} izmeðu ostalih podjela koristi i heksagone koje po potrebi ugnježðuje i tako mijenja rezoluciju u kojoj promatra gibanja. Tvrde da su se u nekim segmentima pokazali i 13\% bolji od pravokutne mreže. 
