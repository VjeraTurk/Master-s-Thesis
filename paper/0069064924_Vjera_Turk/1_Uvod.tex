...
\begin{figure}[!htbp]
	\begin{center}
		...
		\caption{Voronoi dijagram baznih stanica - Shenzhen}
		\label{fig:Voronoi}
	\end{center}
\end{figure}
...
%(linking to transport infrastructure?)
	-k-anonymization \\
	-Grad, Država\\ 
		A potential is also recognized for a planet-scale mobilitiy measurement through opening to researchers and combining the different big dataset carrying location  information.\cite{Scepanovic:2015.}
