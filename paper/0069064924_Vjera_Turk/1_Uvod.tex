...
Kada kontekst (svrha) putovanja nije inicijalno poznat iz prikupljenih podataka o putovanjima, kada je rijeè o novijim metodama estimacije matrica, autori razlièito pristupaju kontekstualizaciji. (...)
...
Podruèje pokrivanja bazne stanice na grafikama se standardno prikazuje kao heksagon. \cite{Teralytics:2017.} izmeðu ostalih podjela koristi heksagone koje po potrebi ugnježðuje  i tako mijenja rezoluciju u kojoj promatra gibanja. Tvrde da su se u nekim segmentima pokazali i 13\% bolji od pravokutne mreže. 

\subsubsection{Interpolacija i usporedba}
\cite{Toole:2015.}
\cite{Bahoken:2013.}

\subsection{Redefiniranje prostorne podjele na temelju matrica}
