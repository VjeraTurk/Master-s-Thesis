...
Konaèna geometrija prostorne podjele alternativnih izvora uglavnom ovisi o prostornoj podjeli \textit{grand truth } matrice èija jedinica prostorne podjele se naziva \gls{taz} kod analize prometa. 
...
Najfinija rezolucija koju je moguæe postiæi kada je rijeè o matricama dobivenim iz \gls{cdr}. 
...
Ponekad operateri u \gls{cdr} zapisima ne otkrivaju položaje baznih stanica veæ njihov ID. Postoji više javno dostupnih baza nastalih volonterskim doprinosom koje pohranjuju podatke o procjenama položaja baznih stanica, snazi signala i sl.

Položaji se prikupljaju pomoæu aplikacije instaliranena mobilnom ureðaju, registriranjem \gls{gps} pozicije i identifikacijske oznake bazne stanice na koju je ureðaj trenutno spojen. Dakle, ove baze ne sadrže "najtoèniji" položaje baznih stanica veæ usrednjeni položaj mobilnih ureðaja koji su u nekom trenutku bili spojeni na tu baznu stanicu. Može se reæi da taj procijenjeni položaj za potrebe izrada matrica èak i više odgovara od stvarnog. \cite{Mellegard:2011.}
