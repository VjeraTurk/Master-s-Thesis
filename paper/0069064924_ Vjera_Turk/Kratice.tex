...
\newacronym{pom}{POM}{Polazišno-odredišna matrica}
%(izvorišno-odredišna matrica)} 
\newacronym{taz}{TAZ}{Traffic Analisys Zone - prometna zona}
\newacronym{iom}{IOM}{Izvorišno-odredišna matrica}
\newacronym{odm}{ODM}{Origin-Destination Martix} 
\newacronym{cdr}{\textnormal{CDR}}{Call Data Records \textnormal{ili} Charging Data Records} 
\newacronym{gsm}{GSM}{Global System for Mobile (Communications)}
\newacronym{rsi}{RSI}{Road Side Interview}
\newacronym{pois}{POIs}{Toèke interesa (engl. Points of Interest)}
\newacronym{hw}{HW}{Home-Work}
\newacronym{wh}{WH}{Work-Home}
\newacronym{ebm}{EBM}{Work-Home}
\newacronym{ssim}{SSIM}{Indeks strukturalne sliènosti (engl.  Structural Similarity Index)}
\newacronym{mssim}{MSSIM}{Više-razinski indeks strukturalne sliènosti (engl. Mean Structural Similarity Index)}
...
\newacronym{gnss}{GNSS}{Globalni navigacijski satelitski sustav}
