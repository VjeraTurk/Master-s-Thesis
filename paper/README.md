1. Encoding not set, TexStudio RELOAD each file with windows-1250, then CHANGE TO windows-1250
then "insert Encoding as Tex comment"

IGNORE (do not change uncomment Linux settings):
